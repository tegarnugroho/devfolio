...
@media (max-width: 639px) { .capability-row { padding: 16px; grid-template-columns: minmax(0,1fr) 22px; gap: 16px; } .capability-icon { grid-column: 1; } .capability-index { grid-column: 2; } .capability-copy, #skills .capability-tags { grid-column: 1 / -1; } .capability-copy h3 { font-size: 10px; } .capability-tags li { padding: 6px 10px; } .capability-list { gap: 10px; } }
